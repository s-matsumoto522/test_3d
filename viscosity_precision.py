...
# 4. グラフタイトル, ラベル付け等
ax1.set_xlim(2.0*np.pi/80, 2.0*np.pi/10)
ax1.set_xscale("log")
ax1.set_yscale("log")
ax1.set_xlabel("dX")
ax1.text(0.1, 0.32, 'slope : 1.891')
ax1.grid(which='both')
ax1.set_title("check the x_viscosity precision")
ax1.legend()
ax2.set_xlim(2.0*np.pi/80, 2.0*np.pi/10)
ax2.set_xscale("log")
ax2.set_yscale("log")
ax2.set_xlabel("dY")
ax2.text(0.1, 0.32, 'slope : 1.891')
ax2.grid(which='both')
ax2.set_title("check the y_viscosity precision")
ax2.legend()
ax3.set_xlim(2.0*np.pi/80, 2.0*np.pi/10)
ax3.set_xscale("log")
ax3.set_yscale("log")
ax3.set_xlabel("dZ")
ax3.text(0.1, 0.32, 'slope : 1.891')
ax3.grid(which='both')
